...
export const firestoreCollections = {
  ...
  products: "safaProducts",
  marketplaceListings: "safaMarketplaceListings",
  hepsiburadaOrderLines: "safaHepsiburadaOrderLines",
  publicInvoiceTokens: "safaPublicInvoiceTokens",
